...
//商户IP
static void * const xwAdd_partnerID_key = AliPartner;
//支付宝账号
static void * const xwAdd_sellerID_key = AliSeller;
//私钥
static void * const xwAdd_partnerPrivKey_key =AliPrivateKey;
...
///
+ (void)xwAdd_registerAlipayWithSign:(NSString *)sign appScheme:(nonnull NSString *)appScheme callbackConfig:(nonnull void (^)(BOOL))config{
     [self xwAdd_sendPayWithOrderInfo:sign appScheme:appScheme callbackConfig:config];
